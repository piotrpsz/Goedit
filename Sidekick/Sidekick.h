 ...
 * DATE   : 17.05.2020
 *******************************************************************/
#ifndef GOEDIT_SIDEKICK_H
#define GOEDIT_SIDEKICK_H
...
*                           Sidekick                                *
********************************************************************/
class Sidekick : public QDockWidget {
    Q_OBJECT

    ProjectTab* const _projectTab;
public:
    explicit Sidekick(QWidget* = nullptr);
};

#endif // GOEDIT_SIDEKICK_H
